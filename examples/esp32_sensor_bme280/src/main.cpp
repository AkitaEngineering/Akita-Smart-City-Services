...
// Create the sensor instance (use C++11-compatible allocation).
// Provide a unique ID for this sensor node.
std::unique_ptr<SensorInterface> myNodeSensor(static_cast<SensorInterface*>(new BME280Sensor("EnvSensor-Node01")));
