...
#define ASCS_DEFAULT_TRUSTED_GATEWAY_NODE 0
...
#define ASCS_DEFAULT_WIFI_SSID ""
#define ASCS_DEFAULT_WIFI_PASSWORD ""
#define ASCS_DEFAULT_MQTT_SERVER ""
#define ASCS_DEFAULT_MQTT_PORT 8883
...
public:
    ...
    uint32_t getTrustedGatewayNodeId() const;
    ...
    std::string getMqttCaCert() const;
...
private:
    ...
    uint32_t m_trustedGatewayNodeId;
